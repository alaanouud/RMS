...
@section('content')
      <div class="contentContainer">
        ...
        <div class="pb-4">
          <a href="{{ route('admin.groups.create') }}" class="btn btn-primary btn-sm col-12 col-sm-3 col-md-2 d-flex justify-content-center align-items-center">
            <i class="mdl-color-text--white-white-400 material-icons" role="presentation">add</i>{{ __('groups.addGroupButton') }}</a>
        </div>
        @if (count($groups) > 0)
